...
def by_position(train,test,pos):
    ...
    filename = pos + 'flex.csv'

    with open(filename, mode='w') as flex:
...
by_position('rb_train.csv','rb_test.csv','rb')
by_position('wr_train.csv','wr_test.csv','wr')
